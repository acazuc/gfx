...
static gfx_cursor_t d3d_create_native_cursor(gfx_window_t *window, enum gfx_native_cursor cursor)
{
...
static void d3d_set_cursor(gfx_window_t *window, gfx_cursor_t cursor)
{
