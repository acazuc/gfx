...
typedef struct gfx_key_event_s
{
	bool used;
...
typedef struct gfx_char_event_s
{
	bool used;
	uint32_t codepoint;
	char utf8[5];
...
typedef struct gfx_mouse_event_s
{
	bool used;
	int32_t x;
	int32_t y;
...
typedef struct gfx_scroll_event_s
{
	bool used;
	int32_t mouse_x;
	int32_t mouse_y;
...
typedef struct gfx_pointer_event_s
{
	bool used;
	int32_t x;
	int32_t y;
...
typedef struct gfx_resize_event_s
{
	bool used;
	int32_t width;
	int32_t height;
...
typedef struct gfx_move_event_s
{
	bool used;
	int32_t x;
	int32_t y;
